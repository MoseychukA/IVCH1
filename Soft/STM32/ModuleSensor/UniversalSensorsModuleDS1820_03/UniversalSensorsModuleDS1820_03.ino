...
#define RANDOM_SEED_PIN A6 // какой пин (АНАЛОГОВЫЙ !!!) использовать для инициализации генератора псевдослучайных чисел (пин должен быть висящим в воздухе)
...
#define LINES_POWER_DOWN_PIN 6 // номер пина, на котором будет управление питанием линий I2C и линий датчиков
...
{mstDHT22,A0,0},               // датчик DHT2x  на пине A0
...
void initLoRa()
{
  ...
  pinMode(A3, OUTPUT);
  digitalWrite(A3,LOW); // Включить питание LoRa
