 ...
 */
#define LORA_SS_PIN             4    // пин SS для LoRa
#define LORA_RESET_PIN          3    // пин Reset для LoRa
#define LORA_IO0_PIN            2    // пин IO0 для LoRa
...
//----------------------------------------------------------------------------------------------------------------
// Настройки 1-Wire
Pin oneWireData(27); // PB11 на втором пине у нас висит 1-Wire
