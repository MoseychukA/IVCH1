...
#define TELEPHON_CAPTION1 "НЕТ НОМЕРА 1"
#define TELEPHON_CAPTION2 "НЕТ НОМЕРА 2"
#define TELEPHON_CAPTION3 "НЕТ НОМЕРА 3"
#define TELEPHON_CAPTION4 "НЕТ НОМЕРА 4"
#define CLEAR_CAPTION "<="
#define TELEPHON_MODE_NO "ВЫКЛЮЧЕН"
#define TELEPHON_MODE_YES "ВКЛЮЧЕН"
#define TELEPHON_MODE_NO_SMS "БЕЗ СТАРТ СМС"
#define TELEPHON_MODE_YES_SMS "СТАРТ СМС"
#define WM_SAVE_CAPTION "СОХРАНИТЬ"
#define WM_START_SMS "СМС ПРИ СТАРТЕ"
...
#define WM_NIGHT_CAPTION "НОЧНОЙ РЕЖ."
...
#define CLEAR_RESET_BUTTON "СБРОСИТЬ НАСТРОЙКИ"
...
#define SPRAY_BUTTON_CAPTION "4 СПРИНКЛЕРЫ"
#define SPRAY_SCREEN_CAPTION "СПРИНКЛЕРЫ"

#define DRAINING_BUTTON_CAPTION "7 ОСУШЕНИЕ"
#define DRAINING_SCREEN_CAPTION "ОСУШЕНИЕ"
...
#define HEAT_DIFF_CAPTION "^ снизить на:(градусов)"
#define HEAT_HISTERESIS_CAPTION "Гистерезис"
#define HEAT_SENSOR_CAPTION "Контур датчик"
#define HEAT_AIR_CAPTION "Климат датчик"
#define HEAT_WORKTIME_CAPTION "Работа привода, с"
#define HEAT_AIR "ВОЗДУХ"
#define NIGHT_ON_CAPTION "РЕЖИМ ВКЛ"
#define NIGHT_OFF_CAPTION "РЕЖИМ ВЫКЛ"
...
#define HEAT_DEFAULT_START_TIME 20
#define HEAT_DEFAULT_DURATION 10
#define HEAT_DEFAULT_NIGHT_TEMP 5
...
//--------------------------------------------------------------------------------------------------------------------------------
#define PIN_EXTENDED_EEPROM_RESET PA15        // номер пина к которому подключена кнопка сброса внешней EEPROM
const long interval_reset = 10000;          // время нажатия кнопки (milliseconds) для запуска прцедуры сброса

#define MAX_TELEPHON_LENGTH           12    // максимальная длина вводимого телефонного номера
...
#define WATERING_TURN_TO_AUTOMODE_AFTER_MIDNIGHT_ADDRESS 320 // адрес настройки "переходить в авторежим после полуночи", 1 байт
#define WATERING_STATUS_EEPROM_ADDR        321 // с какого адреса у нас идут статусы каналов полива, по 5 байт на канал, 100 байт

#define WATERFLOW_EEPROM_ADDR              401 // с какого адреса у нас будут записываться показания датчиков расхода воды, 12 байт

#define DELTA_SETTINGS_EEPROM_ADDR         413 // с какого адреса в EEPROM начинаются настройки дельт, 500 байт на 20 дельт
#define PH_SETTINGS_EEPROM_ADDR            913 // с какого адреса идут настройки PH-модуля, 30 байт
#define TIMERS_EEPROM_ADDR                 943 // у нас 4 таймера, на каждый - 10 байт + заголовок (2 байта), итого - 42 байта 
#define RESERVATION_ADDR                   985 // адрес, с которого пишутся настройки резервирования (10 списков по 12 байт + 3 байта = 123 байта)
...
#define DEBUG_BINDING_ADDRESS              14500 // тут хранятся настройки режима DEBUG
#define DRAINING_BINDING_ADDRESS           14600 // тут хранятся настройки режима осушения
#define WM_HUMIDITY_DRAINING_SETTINGS_ADDRESS  14700 // тут хранятся настройки привязки осушения для поддержания влажности: 3 канала*20 байт = 60 байт
#define WATERING_COUNT_ADDRESS                 14770 // настройки хранения количество включения каналов полива в сутки, 23 байта?
#define WATERING_INTERVAL_ADDRESS              14840 // настройки хранения интервал включения каналов полива в сутки, 23 байта?
#define WM_HEAT_WORKTIME_ADDRESS               14880 //1415 // адрес хранения времени работы приводов отопления, 4 байта*3 контура
#define SMS_NUMBER_EEPROM_ADDR1                14920 // адрес хранения номера телефона хозяина, 15 байт
#define SMS_NUMBER_EEPROM_ADDR2                14940 // адрес хранения номера телефона хозяина, 15 байт
#define SMS_NUMBER_EEPROM_ADDR3                14960 // адрес хранения номера телефона хозяина, 15 байт
#define SMS_NUMBER_EEPROM_ADDR4                15080 // адрес хранения номера телефона хозяина, 15 байт 
#define MODE_NUMBER_EEPROM_ADDR1               15000  // адрес хранения режима номера телефона хозяина, 2 байта
#define MODE_NUMBER_EEPROM_ADDR2               15004 // адрес хранения режима номера телефона хозяина, 2 байта
#define MODE_NUMBER_EEPROM_ADDR3               15008 // адрес хранения режима номера телефона хозяина, 2 байта
#define MODE_NUMBER_EEPROM_ADDR4               15012 // адрес хранения режима номера телефона хозяина, 2 байта
#define WATERING_CHANNELS_SETTINGS_EEPROM_ADDR 15015 // 175 // адрес начала настроек каналов полива, 16 каналов*10 байт на канал - 160 байт
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// TFT model
#define TFT_MODEL_7 CTE70         // SSD1963 (16bit) 800x480
#define TFT_MODEL_4_1 OTM8009A    // OTM8009A (16bit) 800x480 
#define TFT_MODEL_4_2 NT35510     // NT35510 (16bit) 800x480 
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define MODE_ON_COLOR GREEN   // цвет "вкл", "авто"
#define MODE_OFF_COLOR MAROON // цвет "выкл", "ручной"
...
#define TFT_MANUAL_MODE_CAPTION_COLOR YELLOW     //цвет шрифта, которым будет написан ручной режим работы в инфобоксах -КМВ
...
#define TFT_TELEPHONE_BUTTON_CAPTION "ТЕЛЕФОНЫ"
...
#define TFT_WATERING_SETT_HUMBER_COUNT "КОЛИЧЕСТВО ПОЛИВОВ:"
#define TFT_WATERING_SETT_INTERVAL "ИНТЕРВАЛ ПОЛИВОВ,ЧАС:"
#define TFT_WATERING_SETT_SENSOR "ДАТЧИК ПОЧВЫ:"
#define TFT_WATERING_SETT_DURATION "ДЛИТЕЛЬНОСТЬ,"
#define TFT_WATERING_SETT_START "НАЧАЛО, ЧАС:"
#define TFT_WATERING_SETT_START_MIN "НАЧАЛО, МИНУТ:"
#define TFT_WATERING_SETT_SEC "СЕКУНДЫ:"
#define TFT_WATERING_SETT_MIN "МИНУТЫ:"
#define WEB_LINK_URL1 "WWW.GARDENBOSS.RU"
#define WEB_LINK_URL2 "WWW.MADEONLINE.RU"
