...
bool Adafruit_Si7021::begin(void) {
 ...
 // Serial4.println(sernum_a, HEX);
 // Serial4.println(sernum_b, HEX);
...
void Adafruit_Si7021::writeRegister8(uint8_t reg, uint8_t value) {
 ...
 // Serial4.print("Wrote $"); Serial4.print(reg, HEX); Serial4.print(": 0x"); Serial4.println(value, HEX);
}
...
uint8_t Adafruit_Si7021::readRegister8(uint8_t reg) {
  ...
  //Serial4.print("Read $"); Serial4.print(reg, HEX); Serial4.print(": 0x"); Serial4.println(value, HEX);
  return value;
}
