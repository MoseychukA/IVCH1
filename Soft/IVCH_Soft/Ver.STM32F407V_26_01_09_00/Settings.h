...
typedef struct
{
    ...
    uint8_t countBorder;         // количество поливов в сутки
    uint8_t intervalBorder;      // интервал между поливами в сутки поливов в сутки
    uint8_t intervalSecond;      // флаг хранения длительности полива в секундах или минутах
...
typedef struct
{
	bool active;
	int8_t sensorIndex;
	uint8_t drainingOnValue;
	uint8_t drainingOffValue;
	int8_t histeresis;
	int32_t startWorkTime;
	int32_t endWorkTime;
} HumidityDrainingSettings;
#pragma pack(pop)
//--------------------------------------------------------------------------------------------------------------------------------------
...
typedef struct
{
  ...
  bool wing;                 // активность модуля двери при ветре
  bool rain;                 // активность модуля двери при дожде
} DoorSettings;
#pragma pack(pop)
//--------------------------------------------------------------------------------------------------------------------------------------
#ifdef USE_EC_MODULE
...
class GlobalSettings
{
  private:
   ...
   uint8_t wateringChannelsCountBorders[WATER_RELAYS_COUNT];
   uint8_t wateringChannelsIntervalBorders[WATER_RELAYS_COUNT];
   ...
   String NumberIncomingSMS;
   String smsPhoneNumber;
   uint8_t ButtonPhoneNumber;
   uint8_t wifiState;
   String routerID;
  ...
  public:
    ...
    void SetWateringOption(uint8_t val);
     ...
     uint8_t GetWateringCount();
     void SetWateringCount(uint8_t val);

     uint8_t GetWateringInterval();
     void SetWateringInterval(uint8_t val);
    ...
    void SetChannelWateringWeekDays(uint8_t idx, uint8_t val);
     ...
     uint16_t GetChannelWateringCount(uint8_t idx);
     void SetChannelWateringCount(uint8_t idx, uint8_t val);

     uint8_t GetChannelWateringInterval(uint8_t idx);
     void SetChannelWateringInterval(uint8_t idx, uint8_t val);

     uint8_t  GetChannelWateringSecond(uint8_t idx);
     void SetChannelWateringSecond(uint8_t idx, uint8_t  val);
    ...
    int GetButtonPhoneNumber();
    void SetButtonPhoneNumber(int v);


    String GetNumberIncomingSMS();
    void SetNumberIncomingSMS(const String& v);

    String GetSmsPhoneNumber(uint8_t val);
    void SetSmsPhoneNumber(const String& v, uint8_t val);
	...
	HumidityDrainingSettings GetHumidityDrainingSettings(uint8_t channel);
	void SetHumidityDrainingSettings(uint8_t channel, HumidityDrainingSettings& val);
