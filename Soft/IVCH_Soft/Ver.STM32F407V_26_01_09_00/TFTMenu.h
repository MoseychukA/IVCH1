...
#define TFT_TEXT_INPUT_HEIGHT_W 62
#define TFT_ARROW_BUTTON_WIDTH 70
#define TFT_ARROW_BUTTON_HEIGHT 80
#define TFT_ARROW_BUTTON_HEIGHT_W 52
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define TFT_IDLE_SCREENS                7 // сколько у нас экранов на экране ожидания
...
#define TFT_IDLE_WEATHER_SCREEN_NUMBER  6
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
private:
  ...
  DoorSettings MeteoSettings;
  int door1OpenCloseButton, door2OpenCloseButton, windMeteoButton, rainMeteoButton;
  bool door1OpenFlag, door2OpenFlag, windMeteoFlag, rainMeteoFlag, new_windMeteoFlag, new_rainMeteoFlag;
};
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTClearScreen : public AbstractTFTScreen, public MessageBoxResultSubscriber//, public ITickHandler
{
public:
    TFTClearScreen();
    ~TFTClearScreen();
...
private:
  ...
  void drawWeatherData(TFTMenu* menuManager);
 
  void updateWeatherData(TFTMenu* menuManager);
  ...
  void drawUptimeMinutes(TFTMenu* menuManager);
    ...
    uint32_t windSpeed = 0xFFFFFFFF;
    uint32_t windSpeedS = 0xFFFFFFFF;
  ...
  TFTInfoBox* Weather1Box;
  TFTInfoBox* Weather2Box;
  uint8_t TemperatureData, TemperatureDecimalData, HumidityData, HumidityDecimalData;
  ...
  TFTInfoBox* heatBox3Air;
    ...
    int drawMeteo(TFTMenu* menuManager, int curIconRightMargin);
    bool ViewMisol;
    bool SerialViewMisol;
    bool drawStartMeteo;
    bool last_receiver_Misol;
    bool lastdrawMisol;
    uint32_t lastwindSpeed;
    bool ViewData_receive;
    bool data_receive_stab_tmp;
...
class TFTWateringChannelSettingsScreen : public AbstractTFTScreen, public ITickHandler
{
  public:
    ...
    private:
      ...
      TFTInfoBox* minuteBox;
      int decMinuteButton, incMinuteButton;
      void incMinute(int val);
      ...
      int decHumidityBorderMaxButton, incHumidityBorderMaxButton;
      ...
      TFTInfoBox* CountWateringsBox;
      int decCountWateringsButton, incCountWateringsButton;
      void incNumberWaterings(int val);

      TFTInfoBox* IntervalWateringsBox;
      int decIntervalWateringsButton, incIntervalWateringsButton;
      void incIntervalWaterings(int val);
      ...
      uint16_t startWateringMinute;
      uint16_t startWateringTimeM;
      int waterinMinute;
      int8_t wateringSensorIndex;
      uint8_t wateringStopBorder;
      uint8_t wateringStartBorder; 
      uint8_t wateringCount;
      uint8_t wateringInterval;
      uint8_t humiditySensorsCount;
      uint8_t wateringSecond;
...
class TFTSensorsScreen : public AbstractTFTScreen, public KeyboardInputTarget
{
  public:
    ...
    private:
      int backButton, backwardButton, forwardButton, optionsButton, clearMemButton, enterKeyButton;
      TFT_Buttons_Rus* screenButtons;
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTDrainingScreen : public AbstractTFTScreen
{
public:
...
private:
    ...
    void updateDrainingButtons(uint8_t channel, int btnOnOff, int btnMode, bool forceRedraw = false);
    int channel1OnOffButton, channel2OnOffButton, channel3OnOffButton;
    int channel1AutoManualButton, channel2AutoManualButton, channel3AutoManualButton;
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTDrainingSettingsScreen : public AbstractTFTScreen, public ITickHandler
{
public:

    TFTDrainingSettingsScreen(uint8_t channel);
    ~TFTDrainingSettingsScreen();
...
private:
    ...
    // уставка влажности
    TFTInfoBox* drainingOnBox;
    int decDrainingOnButton, incDrainingOnButton;
    void incDrainingOn(int val);

    TFTInfoBox* drainingOffBox;
    int decDrainingOffButton, incDrainingOffButton;
    void incDrainingOff(int val);
    ...
    HumidityDrainingSettings drainingSettings;
...
class TFTHeatSettingsScreen : public AbstractTFTScreen, public ITickHandler
{
  public:
    ...
    private:
      ...
      int backButton, saveButton, nightButton, onOffButton;
      TFT_Buttons_Rus* screenButtons;
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTHeatNightSettingsScreen : public AbstractTFTScreen, public ITickHandler
{
public:

    TFTHeatNightSettingsScreen(uint8_t channel);
...
private:
    ...
    HeatSettings heatNightSettings;
...
class TFTSettingsScreen : public AbstractTFTScreen, public ITickHandler
{
  public:
    ...
    private:
       int backButton, timeSyncButton, decOpenTempButton, incOpenTempButton, decCloseTempButton, incCloseTempButton, incIntervalButton, decIntervalButton, telephoneButton;
      TFT_Buttons_Rus* screenButtons;
...
class MessageBoxScreen : public AbstractTFTScreen
{
  ...
  void show_noButton(const char* _caption, Vector<const char*>& _lines);
...
//TFTTelephonMenu
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTTelephoneMenu : public AbstractTFTScreen
{
public:
...
private:
    ...
    TFT_Buttons_Rus* screenButtons;
    String enteredTelephon, telephon_EEPROM;
    String wiev_tel_button;
    int textBox;
    int lastKeyButtonID;
    int backButton, telephon1, telephon2, telephon3, telephon4;
    int  tel1mode1, tel1mode2, tel2mode1, tel2mode2, tel3mode1, tel3mode2, tel4mode1, tel4mode2;
    bool  tel1mode1set, tel1mode2set, tel2mode1set, tel2mode2set, tel3mode1set, tel3mode2set, tel4mode1set, tel4mode2set;
    bool tel_view1, tel_view2, tel_view3, tel_view4;
    int idx_telephone;

};

//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTTelephoneScreen : public AbstractTFTScreen
{
public:
...
private:
    ...
    int textBox;
    int lastKeyButtonID;
    int backButton, saveButton, clearButton, plusButton;
