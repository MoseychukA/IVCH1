...
public:
  ...
  Adafruit_PCF8575* PCF8575Extenders[COUNT_OF_PCF8575_EXTENDERS];
  void InitPCF8575Extenders();
  Adafruit_PCF8575* GetPCF8575_ByAddress(byte addr);
#endif 
...
#if defined(USE_PCF8575_EXTENDER) && COUNT_OF_PCF8575_EXTENDERS > 0
    // запись в каналы PCF8575
    void PCF8575_PinMode(byte mcpAddress, byte mpcChannel, byte mode);
    void PCF8575_PinWrite(byte mcpAddress, byte mpcChannel, byte level);
    byte PCF8575_PinRead(byte mcpAddress, byte mpcChannel);
#endif 
