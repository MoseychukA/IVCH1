...
#define SSD1311_RIGHT_HORIZONTAL_SCROLL 0x26              ///< Init rt scroll
#define SSD1311_LEFT_HORIZONTAL_SCROLL 0x27               ///< Init left scroll
#define SSD1311_VERTICAL_AND_RIGHT_HORIZONTAL_SCROLL 0x29 ///< Init diag scroll
#define SSD1311_VERTICAL_AND_LEFT_HORIZONTAL_SCROLL 0x2A  ///< Init diag scroll
#define SSD1311_SET_VERTICAL_SCROLL_AREA 0xA3             ///< Set scroll range

#define SSD1311_DEACTIVATE_SCROLL 0x2E                    ///< Stop scroll
#define SSD1311_ACTIVATE_SCROLL 0x2F                      ///< Start scroll
...
class SSD1311 {
	public:
		...
		void printRus(const char* String, uint8_t col, uint8_t row);
