...
// default SS pin for ethernet, use it.
  ...
  #if !defined(SS_PIN_DEFAULT)
    #define SS_PIN_DEFAULT  PA4
  #endif

  #if (_ETG_LOGLEVEL_ > 3)
    #warning w5100_Impl.h : Use __AVR__, change SS_PIN_DEFAULT to PA4
  #endif
  ...
  // use them if none of the other cases match
      ...
      #warning w5100_Impl.h : Use __SAMD21G18A__, change SS_PIN_DEFAULT to PA4
    #endif
  ...
  #if (_ETG_LOGLEVEL_ > 3)
    //KH
    #warning w5100_Impl.h : Use fallback, change SS_PIN_DEFAULT to PA4
  #endif
...
uint8_t         W5100Class::CH_BASE_MSB;
  ...
  uint8_t         W5100Class::ss_pin = PA4;// SS_PIN_DEFAULT;
