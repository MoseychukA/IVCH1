...
#if defined(ARDUINO_ARCH_STM32) && (defined(STM32F407VG) ||defined(STM32F407VE) || defined(STM32F407ZE) || defined(STM32F407ZG))
  #define STM32F4xx      // Установить тип микроконтроллера (текущий вариант STM32F407VET6)
#endif

#if defined(ARDUINO_ARCH_STM32) && (defined(STM32F103ZG)|| defined(STM32F103VE))
#define STM32F1xx      // Установить тип микроконтроллера (текущий вариант STM32F103VET6)
#endif
