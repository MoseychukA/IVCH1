...
//// HOME:если IP строка "0.0.0.0" или пустая — показываем "NOT CONNECTED"
//static bool isIpStrZero(const char* s)
//{
...
private:
	...
	void commitSave() {
		...
		if (!okSync) Serial.println(F("SyncSourcesStore.save FAILED"));
