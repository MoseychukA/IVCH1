...
//--------------------------------------------------------------------------------------------------------------------------------
// закомментировать, если не нужен модуль контроля освещенности (BH17500)
...
//--------------------------------------------------------------------------------------------------------------------------------
#define USE_CLEAR_MEMORY // закомментировать, если не нужно очищать память
//--------------------------------------------------------------------------------------------------------------------------------
#define USE_WEATHER_MODULE // закомментировать, если не нужны датчики метеостанции см. ниже
//--------------------------------------------------------------------------------------------------------------------------------
...
// использовать или нет расширители портов PCF8575, при этом модули, которые поддерживают работу через эти расширители, могут работать через них. 
// Настройки расширителя на I2C смотрите ниже.
//#define USE_PCF8575_EXTENDER // раскомментировать, если хотите использовать PCF8575 (работу через них поддерживает модуль полива и модуль досветки)
...
/* как работают диоды:
  ...
  linkPCF8575   // привязка к PCF8575
*/
...
#define READY_DIODE_PIN 0xFF // пин (или номер канала MCP) диода готовности
#define BLINK_READY_DIODE 1 // мигать диодом готовности? (0 - нет, 1 - да)

#define WINDOWS_DIODE_PIN 0xFF// пин (или номер канала MCP) диода режима окон
#define WATERING_DIODE_PIN 0xFF// пин (или номер канала MCP) диода режима полива
#define LIGHT_DIODE_PIN 0xFF // пин (или номер канала MCP) диода режима досветки
...
#define WIFI_PING_HOST        F("google.com")  // хост для пингования на предмет обнаружения неполадок со связью
...
#define COUNT_OF_MCP23S17_EXTENDERS 3 // сколько расширителей портов MCP23S17 используется (0 - нисколько)
#define MCP23S17_ADDRESSES 1, 2, 3 // адреса расширителей MCP23S17, через запятую, кол-вом COUNT_OF_MCP23S17_EXTENDERS
...
#define MCP23017_ADDRESSES 1,2,3

#define COUNT_OF_PCF8575_EXTENDERS 0          // сколько расширителей портов PCF8575 используется (0 - нисколько)
// адреса расширителей PCF8575, через запятую, кол-вом COUNT_OF_PCF8575_EXTENDERS
// 0 - первый адрес 0x20, 1 - второй адрес 0x21 и т.п.
#define PCF8575_ADDRESSES 1, 2, 3, 4, 5, 6, 7


//--------------------------------------------------------------------------------------------------------------------------------
// НАСТРОЙКИ ВНЕШНЕГО ВАТЧДОГА (актуально при раскомментированной команде USE_EXTERNAL_WATCHDOG)
//--------------------------------------------------------------------------------------------------------------------------------
#define WATCHDOG_REBOOT_PIN         PE2   // номер пина, на котором будут меняться уровни
...
#define WATCHDOG_WORK_INTERVAL     2000   // через сколько миллисекунд на ноге будет уровень WATCHDOG_TRIGGERED_LEVEL
...
#define LORA_REBOOT_PIN            16 // пин управления питанием (0xFF - не используется)
#define LORA_POWER_ON             LOW // уровень включения питания
#define LORA_SS_PIN                54 // пин SS (0xFF - не используется)
#define LORA_RESET_PIN             60 // пин RESET (0xFF - не используется)
...
// пин пищалки
#define BUZZER_PIN PD11 // Main_STM32F407VGT6_Micro_01
//#define BUZZER_PIN 59 // Main_STM32F407VGT6_Mini_02
...
// настройки для дисплея 4 дюйма, 480х800, драйвер дисплея OTM8009A
...
#define  INCH_4_TOUCH_MIN_RAW_X 170//260     // Реальная минимальная величина по оси X (подстроить под конкретный дисплей)
#define  INCH_4_TOUCH_MAX_RAW_X 3930//3750    // Реальная максимальная величина по оси X(подстроить под конкретный дисплей)

#define  INCH_4_TOUCH_MIN_RAW_Y 250//245     // Реальная минимальная величина по оси Y (подстроить под конкретный дисплей)
#define  INCH_4_TOUCH_MAX_RAW_Y 3830//3850    // Реальная максимальная величина по оси Y(подстроить под конкретный дисплей)
...
#define TFT_BACKLIGHT_MCP_ADDRESS  0     // номер MCP
...
#define TFT_OFF_DELAY      1800000ul     // время выключения подсветки экрана при бездействии, миллисекунд (30 минут)
#define TFT_DISPLAY_TYPE           3     // тип дисплея (0 - не используется, 1 - 7 дюймов SSD1963 (16bit) 800x480, 2 - 4 дюйма OTM8009A (16bit) 800x480, 3 - 4 дюйма  NT35510 (16bit) 800x480 )
...
//--------------------------------------------------------------------------------------------------------------------------------
#define GSM_PING_HOST F("google.com") // хост, который пингуем
...
#define GSM_SEND_WORK_STARTED_SMS       0 // посылать СМС при старте контроллера в работу? (0 - нет, 1 - да)
...
//--------------------------------------------------------------------------------------------------------------------------------
// настройки модуля метеостанции Misol
//--------------------------------------------------------------------------------------------------------------------------------
#define DRAW_METEO_ON_SCREEN             // закомментировать, если не нужно отображать работу метеостанции Misol на TFT-экране
...
#define WIND_RAIN_UPDATE_INTERVAL   120000ul    // (очень долго не было данных, сбрасываем)
#define WIND_RAIN_CONTROL_INTERVAL    4000ul    // Время обнаружения начала дождя
...
//--------------------------------------------------------------------------------------------------------------------------------
// настройки управления осушения для поддержания влажности
//--------------------------------------------------------------------------------------------------------------------------------
#define USE_HUMIDITY_DRAINING_MODULE                  // закомментировать, если не надо использовать модуль осушения для поддержания влажности (3 канала)
//--------------------------------------------------------------------------------------------------------------------------------
