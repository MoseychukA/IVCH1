...
#include <GxIO/STM32GENERIC/GxIO_STM32F4_FSMC/GxIO_STM32F4_FSMC.h>  // Версия для подключения FSMC "BLACK F407VE/ZE/ZG boards".
  ...
  #include <GxCTRL/GxCTRL_OTM8009A/GxCTRL_OTM8009A.h> // 480х800  Подключение информации по настройке драйвера дисплея OTM8009A
#elif (TFT_DISPLAY_TYPE == 3) // 4 ''
...
//#define BigRusFont (&keyrus) // какой шрифт юзаем
#define BigRusFont (&BigRusFont) // какой шрифт юзаем
