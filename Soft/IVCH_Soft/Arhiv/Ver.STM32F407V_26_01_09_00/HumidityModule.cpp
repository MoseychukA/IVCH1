...
HumidityAnswer HumidityModule::QuerySensor(uint8_t sensorNumber, uint8_t pin, uint8_t pin2, HumiditySensorType type)
{
  ...
  switch(type)
  {
    ...
    case SI7021:
    {
      ...
      {
         HumidityBinding hbnd = HardwareBinding->GetHumidityBinding();
       //  Serial4.println("SI7021 STROBE OFF!!!");
      ...
      {
         HumidityBinding hbnd = HardwareBinding->GetHumidityBinding();
        // Serial4.println("SI7021 STROBE ON!!!");
      ...
      if(!si7021Inited)
      {
        // Serial4.println("SI7021 NOT INITED!!!");
        ...
        //  Serial4.println("SI7021 NOW INITED.");
      }

     //  Serial4.println("READ FROM SI7021");
