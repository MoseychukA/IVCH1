...
static const char* USER = "mts";
static const char* PASS = "mts";
...
//-----------------------------------------------------------------------
    ...
    sim.setDebug(&Serial, false); // true -> печатать AT/ответы
    sim.begin(SIM_BAUD);
