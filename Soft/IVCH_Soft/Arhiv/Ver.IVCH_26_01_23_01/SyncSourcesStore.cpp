...
bool SyncSourcesStore::loadLoose(Data& d) {
	...
	if (!readU16(ADDR_MAGIC, mg) || mg != MAGIC) {
		// EEPROM пуста€/неинициализирована
		return false;
	}
	...
	if (ver == 1) {
		// --- миграци€ со старого формата (8 байт) ---
	...
	// неизвестна€ верси€ Ч оставить defaults
	return false;
}
