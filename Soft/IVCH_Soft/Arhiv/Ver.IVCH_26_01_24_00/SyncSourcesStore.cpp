...
bool SyncSourcesStore::save(const Data& d) {
	...
	// ¬ерификаци€ чтением назад (чтобы сразу ловить "не пишетс€ физически")
	Data rd;
